 ...
 */
public class DoorKnockBolt extends BaseBasicBolt {
    ...
    public void execute(Tuple tuple, BasicOutputCollector basicOutputCollector) {
        try {
            ...
            dogbark = checkDoorKnock(feature);
...
//            double[] result = featureExt.extractFeature(sample, sampleRate, otherFeatures);
            Boolean check = checkDoorKnock(feature);
    ...
    public static void insertIntoMongoDB(Boolean check) {
        String API_KEY = "crX7LsiVFEMe20vIzUd5FXlL3VKsNhDh";
        ...
        try {
            ...
            jsonObject.put("Context", "DoorKnock");
    ...
    public Boolean checkDoorKnock(double[] feature) {
