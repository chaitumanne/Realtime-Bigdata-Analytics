...
public class Class4Bolt extends BaseBasicBolt {
    private static final Logger LOG = LoggerFactory.getLogger(Class4Bolt.class);
    public void execute(Tuple tuple, BasicOutputCollector basicOutputCollector) {
        try {
            ...
            Boolean check = checkClass4(feature);
    ...
    public Boolean checkClass4(double[] feature) {
