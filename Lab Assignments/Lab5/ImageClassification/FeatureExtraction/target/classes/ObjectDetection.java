...
//                new FastBasicKeypointMatcher<Keypoint>(8));
        final RobustHomographyEstimator ransac = new RobustHomographyEstimator(0.1, 1500,
...
//        this.matcher5.setFittingModel(ransac);
    ...
    public void StartVideo() throws IOException {
        Video<MBFImage> video = new XuggleVideo("data/ATM.mkv");
...
//            }
    ...
    public void LoadReferenceObject() {
        ...
        try {
            modelImage1 = ImageUtilities.readMBF(new File("data/Person1.jpg"));
            modelImage2 = ImageUtilities.readMBF(new File("data/Person2.JPG"));
